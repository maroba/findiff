...
import os
import sys
sys.path.insert(0, os.path.abspath('../findiff'))
...
latex_documents = [
    (master_doc, 'findiff.tex', 'findiff Documentation',
...
texinfo_documents = [
    (master_doc, 'findiff', 'findiff Documentation',
     author, 'findiff', 'One line description of project.',
     'Miscellaneous'),
]
